...
if(isset($_SESSION['loggedIn'])){
    ...
    while($row = $result->fetch()) {
        ...
        $keeplname = $row["CustomerNAWLastname"];
        $keepemail = $row["CustomerEmail"];
        $keepcountry = $row["CustomerNAWCountry"];
        $keepprovince = $row["CustomerNAWProvince"];
        $keepcity = $row["CustomerNAWCity"];
        $keepaddress = $row["CustomerNAWAddress"];
        $keepzip = $row["CustomerNAWZip"];
        $keepphone = $row["CustomerNAWPhone"];
...
<div class="container">
    <div class="row">
        <div class="col-sm-6" style="margin-left: 450px;">
			...
			<?php include "deliveryDetailsCheck.php"?>
		</div>
    </div>
</div>
<?php
